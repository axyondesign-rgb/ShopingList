...
import { ShoppingList, ShoppingItem, useAppLogic } from '../hooks/useAppLogic';

export type ShoppingAppUIProps = ReturnType<typeof useAppLogic>;

export function ShoppingAppUI(props: ShoppingAppUIProps) {
  const {
    lists,
    items,
    activeListId,
